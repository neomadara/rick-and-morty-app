...
describe('Home', () => {
  ...
  test.todo('Should render more results when the user get the bottom of list')
  test.todo('Should search a character when the user use the search input')
  test.todo('Should show a detail view of a character if the user tap a result')
})
